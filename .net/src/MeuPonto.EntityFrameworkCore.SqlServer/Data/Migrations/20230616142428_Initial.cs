        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ApuracaoMensal_TempoTotalPrevisto = table.Column<TimeSpan>(type: "time", nullable: true),
                    ApuracaoMensal_TempoTotalApurado = table.Column<TimeSpan>(type: "time", nullable: true),
                    ApuracaoMensal_DiferencaTempoTotal = table.Column<TimeSpan>(type: "time", nullable: true),
                    ApuracaoMensal_TempoTotalPeriodoAnterior = table.Column<TimeSpan>(type: "time", nullable: true),
                    CreationDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Version = table.Column<byte[]>(type: "rowversion", rowVersion: true, nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TempoPrevisto = table.Column<TimeSpan>(type: "time", nullable: false),
                    TempoApurado = table.Column<TimeSpan>(type: "time", nullable: true),
                    DiferencaTempo = table.Column<TimeSpan>(type: "time", nullable: true),
                    TempoAbonado = table.Column<TimeSpan>(type: "time", nullable: true),
