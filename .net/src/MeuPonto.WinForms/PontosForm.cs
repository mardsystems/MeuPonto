...
namespace MeuPonto
{
    public partial class PontosForm : Form
    {
        ...
        private void PontosForm_Load(object sender, EventArgs e)
        {
            ...
            // TODO: This line of code loads data into the 'mainDataSet.PontoComprovantes' table. You can move, or remove it, as needed.
            this.pontoComprovantesTableAdapter.Fill(this.mainDataSet.PontoComprovantes);
